...
# Model architecture configuration - only update model info, keep original checkpoint
MODEL_CONFIG = {
    "name": "RoBERTa Base",
    "checkpoint": "./RoB",  # Keep original path
    "architecture": {
        "type": "Robustly Optimized BERT Pretraining Approach",
        "layers": 12,
        "hidden_size": 768,
        "attention_heads": 12,
        "parameters": "125M parameters",
        "activation": "GELU",
        "description": "RoBERTa improves on BERT by removing the Next Sentence Prediction task, using dynamic masking, and training on more data"
    }
}

# Hyperparameter settings - keep completely unchanged
HYPERPARAMETERS = {
    "learning_rate": 1e-5,
    "batch_size": 16,
    "epochs": 4,
    ...
    "weight_decay": 0,
    "dropout": 0.1  # Default dropout in RoBERTa model
}
...
def main():
    ...
    # =============================
    # 3) Initialize tokenizer - changed to RoBERTa tokenizer
    # =============================
    ...
    # Modified: Use RoBERTa tokenizer
    ...
    # =============================
    # 5) Initialize RoBERTa for Classification - modified model
    # =============================
    print("\n=== 5) Initialize RoBERTa for Classification ===")
    # Modified: Use RoBERTa model
    ...
    # =============================
    # 6) Compile & train (multi-epoch + EarlyStopping) - keep original parameters
    # =============================
    print("\n=== 6) Compile & train ===")
    ...
    # Keep original optimizer settings
    ...
    checkpoint_path = "./checkpoints/roberta_model"
